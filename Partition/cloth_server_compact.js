...
Corresponding client js file: js/cloth_client_compact.js
Corresponding html file: index_compact.html
...
io.sockets.on('connection', function(socket){
   ...
   socket.on('updateCloth', function(data){
       ...
       sCloth.points = [];
       cloth.update();
       //console.log('Time Taken update: '+(new Date().getTime() - start));
       /*var p = {
         cloth : sCloth.points,
         id : id,
         time: new Date().getTime()
